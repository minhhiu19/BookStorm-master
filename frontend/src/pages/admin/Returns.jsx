...
function Returns() {
  ...
  const fetchReturns = useCallback(async () => {
    try {
      setLoading(true);
      const res = await adminService.getReturnRequests(page, 20, activeTab || null);
                  ...
                  {returns.map((item) => {
                    ...
                    return (
                      <tr key={item.id}>
                        ...
                        <td>{item.customerName || item.user?.fullName || '---'}</td>
                        <td>
              ...
              <div className={styles.detailGrid}>
                <div className={styles.detailItem}>
                  ...
                  <span className={styles.detailValue}>
                    {selectedReturn.customerName || selectedReturn.user?.fullName || '---'}
                  </span>
                </div>
                <div className={styles.detailItem}>
